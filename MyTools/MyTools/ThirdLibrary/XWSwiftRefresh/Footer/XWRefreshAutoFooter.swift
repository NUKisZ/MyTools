...
/** footerView 什么样式都没有的 */
open class XWRefreshAutoFooter: XWRefreshFooter {
...
//    @available(*, deprecated=1.0, message="Use -automaticallyChangeAlpha instead.")
    ...
    //MARK: 实现父类的接口
    override func scrollViewContentSizeDidChange(_ change: Dictionary<String, AnyObject>?) {
    ...
    override func scrollViewPanStateDidChange(_ change: Dictionary<String, AnyObject>?) {
